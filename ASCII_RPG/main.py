...
from weapon import iron_sword, silver_sword, mythril_sword, short_bow, silver_bow, orc_blade, scythe, xcal
import game_data
from PIL import Image

hero = Hero("Warrior", 40, 0, 1, 0, iron_sword)#initial load
        ...
        if wep_choice == "1":
            ...
            if buy_op == "1":
                if hero.gold >= 50:
                    ...
                    print("you have equipped the silver sword!")
                    hero.gold -= 50
                else:
                ...
                if hero.gold >= 40:
                    ...
                    print("you have equipped the short_bow")
                    hero.gold -= 40
                else:
                    print("You don't have enough gold!")
                    input("> ")
            elif buy_op == "3" or buy_op == "7":
                break
            elif buy_op == "4":
                if hero.gold >= 145:
                    hero.weapon = mythril_sword
                    print("you have equipped the mythril sword!")
                    hero.gold -= 145
                else:
                    print("You don't have enough gold!")
                    input("> ")
                ...
                if hero.gold >= 100:
                    ...
                    print(" You have equipped the silver bow!")
                    hero.gold -= 100
                else:
                    print("You don't have enough gold!")
            elif buy_op == "6":
                if hero.gold >= 600:
                    hero.weapon = xcal
                    print(" you have equipped the xcal!")
                    hero.gold -= 600
                else:
                    print("You don't have enough gold!")
...
def battle():
    ...
    if hero.level < 6:
        ...
        enemy2 = minions + elites # all enemies are in play now!
    ...
    while fight:
        ...
        if hero.level > 5 and game_data.megapotion > 0:
            print("3 - Use MegaPotion (70HP) ")
        ...
        elif choice == "3" and game_data.megapotion > 0:
            game_data.megapotion -= 1
            heal(70)
            print(f"{hero.name} heals for 70 HP!")
            enemy.attack(hero)
...
def check_level_up():
    level_amount = hero.level * 100 - 50
...
def shop():
    ...
    while buy:
        ...
        print("2 - LUCK CHANCE(Dodge) + 1 - 80 GOLD")
        if hero.level >= 6:
...
while run:
    ...
    while play:
        ...
        if play:
            ...
            print("POTIONS: " + str(game_data.pot))
            if hero.level > 5:
                print("MegaPotion " + str(game_data.megapotion))
            print("GOLD: " + str(hero.gold))
            ...
            if game_data.megapotion > 0 and hero.level > 5:
                print("8 - Use Megapotion (70HP)")    
            if y > 0 or x > 0:
                print("6 - Map")    
